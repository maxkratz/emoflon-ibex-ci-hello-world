...
import org.emoflon.ibex.ci.helloworld.gt.api.GtAPI;
...
public class EmoflonGtAppUtils {
	...
	public static void extractFiles(final String workspacePath) {
		final File target = new File(workspacePath + GtAPI.patternPath);
		if (target.exists()) {
			return;
		}
		try (final InputStream is = HelloworldApp.class
				.getResourceAsStream("/org/emoflon/ibex/ci/helloworld/gt/api/ibex-patterns.xmi")) {
